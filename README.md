...
- [Interop](https://github.com/web-platform-tests/interop), groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt)
...
- [Simulateur Prix Construction Maison](https://simulateur-prix-construction-maison.fr/) - Estimation gratuite du coût de construction d'une maison neuve en France. 36 critères, 25 postes budgétaires.
